    ...
    MESSAGES: [
        {
    		...
    		rcinfo: {
    			...
    			dstIp: '3l4k:s4bb:l3dd:z3pp:jim1:3drx:p1nk:fl0y',
    			srcPort: 5060,
    	  		dstPort: 5070
    		},
    		pause: 0,
            ...
            'INVITE sip:hepgen@lge.qxip.ipcx.nl;user=phone SIP/2.0\r\n'+
                ...
                's=FreeSWITCH\r\n'+
                'c=IN IP6 21a0:m4m4:qx1p:s1p4::5555\r\n'+
                't=0 0\r\n'+
        ...
        },
        {
            ...
            'SIP/2.0 100 Trying\r\n'+
                ...
                'Via: SIP/2.0/UDP [21A0:M4M4:QX1P:S1P4:0:0:0:1234];branch=z9hG4bK934d.2b60491d4b2268c90e588d8a91e4bba9.0\r\n'+
                'Content-Length: 0\r\n'+
                'Contact: <sip:Fr4nkV1ncentZ4ppa@[3l4k:s4bb:l3dd:z3pp:jim1:3drx:p1nk:fl0y];transport=udp>\r\n'+
